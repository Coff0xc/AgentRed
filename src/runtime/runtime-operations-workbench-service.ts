...
function eventContract(): RuntimeEventContract[] {
  return [
    ...
    contract('approval_event', 'mapped', 'ApprovalService', ['approvalId', 'tool', 'riskLevel', 'status'], 'Approval queue and interruption points', 'R3 pauses for a human; R4 is denied by default and needs break-glass token plus approval.'),
