...
test.skip('Platform wires MCP service and ToolGateway enforces inferred MCP risk', async () => {
  // TODO: Re-enable when MCP service is re-integrated
  // MCP service was temporarily removed during refactoring
});

test.skip('MCP invocation errors are returned as blocked ToolGateway results', async () => {
  // TODO: Re-enable when MCP service is re-integrated
  // MCP service was temporarily removed during refactoring
});
